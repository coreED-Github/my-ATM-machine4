...
if (pinAnswer.pin === myPin) {
    ...
    if (operationAns.operation === "your acount type information") {
        ...
        if (AcountTypes.myAcount === "currentAcount") {
            ...
            console.log("its not your account but you transfer your account in to saving account");
        }
        else if (AcountTypes.myAcount === "basicAcount") {
            console.log("its not your account but you transfer your account in to basicAcount");
        }
        else if (AcountTypes.myAcount === "jointAcount") {
            console.log("its not your account but you can join your account with your relatives or friends");
        }
        else {
    ...
    if (operationAns.operation === "withdraw") {
        ...
        if (amountAns.amount === "option") {
            ...
            if (myBalance >= othernum.Amount) {
                ...
                console.log("the number selected by you is less than your balance  please try again");
            }
        }
    }
        ...
        console.log("citizen Apartment,Plot No SL-23, Shahrah-e-usman north karachi");
    }
}
else {
